...
class NotificationService {
  ...
  Future<void> init() async {
    ...
    await (plugin as dynamic).initialize(initializationSettings);
  }
  ...
  Future<void> showNotification(int id, String title, String body, {bool silent = false}) async {
    ...
    final dynamic plugin = flutterLocalNotificationsPlugin;
    await (plugin as dynamic).show(id, title, body, platformChannelSpecifics);
  }
  ...
  Future<void> scheduleNotification(int id, String title, String body, DateTime scheduledTime,
    ...
    final dynamic plugin = flutterLocalNotificationsPlugin;
    await (plugin as dynamic).zonedSchedule(
      id,
      title,
      body,
